...
**Target File:** `docs/DRONE_PHYSICS_ENGINE_SPEC.md`
*(Note to Developer: Reference this document in your repository's root `AGENTS.md` to ensure Codex automatically inherits these architectural constraints.)*
